 ...
 * Content elements
 */
$GLOBALS['TL_DCA']['tl_content']['palettes'][CohCanvasElement::TYPE] = '{type_legend},type,headline;{template_legend:hide},coh_canvas_template;{expert_legend:hide},cssID;{invisible_legend:hide},invisible,start,stop';
$GLOBALS['TL_DCA']['tl_content']['fields']['coh_canvas_template'] = [
    'label'            => &$GLOBALS['TL_LANG']['tl_module']['coh_template'],
    'exclude'          => true,
    'inputType'        => 'select',
    'options_callback' => static function () {
        $templates = \Contao\System::getContainer()->get('contao.content_template')->getTemplates();
        file_put_contents(TL_ROOT . '/debug_templates.log', print_r($templates, true));
        return $templates;
    },
